...
describe('IndiceEntidadComponent', () => {
    beforeEach(async () => {
        ...
        mockIServicioCRUD = jasmine.createSpyObj<IServicioCRUD<object, object>>('IServicioCRUD', ['obtenerPaginado', 'borrar']);
        ...
        await TestBed.configureTestingModule({
            ...
            providers: [{ provide: SERVICIO_CRUD_TOKEN, useValue: mockIServicioCRUD }, provideAnimationsAsync()]
        }).compileComponents();
    });
