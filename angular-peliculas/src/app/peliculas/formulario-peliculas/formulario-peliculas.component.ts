...
@Component({
  ...
  imports: [RouterLink, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatButtonModule, MatDatepickerModule, InputImgComponent, SelectorMultipleComponent],
